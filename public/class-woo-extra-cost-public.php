...
class Woo_Extra_Cost_Public {
    ...
    function woo_add_cart_fee_based_on_country() {
        ...
        if (in_array($woocommerce->customer->get_shipping_country(), $county)) :
			$extraCostLabel = $get_extra_rate->extra_cost_name;
			$surcharge = $get_extra_rate->extra_cost_value;
            $woocommerce->cart->add_fee($extraCostLabel.':', $surcharge, true, '');
        endif;
    }
     ...
     * BN code added
     */
    function paypal_bn_code_filter_woocommerce_extra_cost($paypal_args) {
